<template>
    <div>
        ...
        <form @submit.prevent="createItem" class="flex flex-wrap justify-between w-[70%] py-5" action="">
            <div class="w-[45%]">
                ...
                <div class="my-3">
                    ...
                    <select v-model="item.item_type" class="w-full my-2 py-1.5 px-2 text-gray-500 bg-gray-100"  name="" id="">
...
import ApiService from '@/services/APIService';
    export default {
        ...
        methods : {
            createItem(){
                ApiService.post('admin/items',this.item).then((res)=> {
